...
app = FastAPI(
    ...
    description="Asistente IA para Credit Card Fraud Detection",
    version="1.0.0"
)
...
class Consulta(BaseModel):
    ...
    - Si viene    → usuario existente → retomamos su conversación en memoria RAM
...
def raiz():
    ...
    """
    return {"status": "ok", "project": "Credit Card Fraud Detection"}
...
def consultar(consulta: Consulta):
    ...
    return Respuesta(session_id=session_id, respuesta=resultado["respuesta"], mensajes_en_memoria=resultado["mensajes_en_memoria"])
